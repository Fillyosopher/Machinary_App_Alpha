...
public class MachineAdapter extends ArrayAdapter<String> {
	...
	private MachineDataSource mDataSource;
	private String[] allColumns;
	
	public MachineAdapter( Context context, List<String> objects, List<List<Machine>> cards, HListView list, MachineDataSource database) {
		...
		allColumns = mDataSource.getColumnNames();
	}
	...
	private void addCards(int arg0) {
		...
		mDataSource.createMachine("Empty", arg0, "");
		Machine newMachine = mDataSource.getMachineByList(arg0).get(0);
