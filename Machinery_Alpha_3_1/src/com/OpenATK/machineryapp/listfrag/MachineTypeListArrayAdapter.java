...
public class MachineTypeListArrayAdapter extends ArrayAdapter<MachineTypeList> {
	...
	public MachineTypeListArrayAdapter(Context context, int layoutResourceId, List<MachineTypeList> data,
			int innerLayoutResourceId, DatabaseHelper dbHelper, int order, String searched,
			...
			if (machineList.size() != 0){
				...
				holder.innerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
		            ...
		            public void onItemClick(AdapterView<?> parent, View view, int position,
		            	...
		            	listener.FragmentList_Done(machine);
		            }
		        });
